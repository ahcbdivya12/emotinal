...
header nav a:hover {
    ...
    <h1 style="margin-right: -20px;">Emontional Book</h1>
                <nav style="margin-left: 150px;font-weight: bold;   ">
                    <a href="books_page.php" style="color : #000;">Home</a>
                    <a href="books_page.php?page=products"style="color : #000;">Books</a>
                    <a href="books_page.php"style="color : #000;">Musics</a>
                    <a href="books_page.php"style="color : #000;">Theripist</a>
